...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если ПустаяСтрока(Объект.ПутьПроцедуры) Тогда
		Объект.ПутьПроцедуры                          = "хе_Тестовые.ОтветGetЗапроса";
		Объект.ПутьПроцедурыОбработкиСтрокиРезультата = "хе_Тестовые.ОбработатьСтрокуРезультата";
		Объект.ЭтоФункция                             = Истина;
	КонецЕсли;
